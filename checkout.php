...
<body>
    ...
    <div class="row">
        <div class="col-75">
            <div class="container">
                    ...
                    <div class="row">
                        <div class="col-50">
                            ...
                            <input type="text" id="fname" name="firstname"placeholder="Put in your username">
                            <label for="email"><i class="fa fa-envelope"></i> Email</label>
                            <input type="text" id="email" name="email" placeholder="smt@example.com">
            ...
            <input type="submit" placeholder="Continue to checkout" class="btn">
            </form>
        </div>
    </div>
    <div class="col-25">
